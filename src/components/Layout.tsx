...
export const Layout = ({ children }: LayoutProps) => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center px-8 md:px-32 xl:px-[26rem] 3xl:px-[34rem]">
      ...
      {children}
      <footer className="h-24 w-full text-xs flex items-center justify-center pointer-events-none select-none">
